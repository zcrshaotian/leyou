...
//        Map<String, String> parseMap = parseMap(map, String.class, String.class);
//        System.out.println("parseMap = " + parseMap);

        //json转化为复杂类型的集合
//        String list = "[{\"name\": \"jack\", \"age\": \"21\"}, {\"name\": \"rose\", \"age\": \"18\"}]";
//        List<Map<String, String>> maps = nativeRead(list, new TypeReference<List<Map<String, String>>>() {
//        });
//
